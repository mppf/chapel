...
#include <stdio.h>
const char* chpl_compileCommand = "chpl -g -o ../example/experiment ../example/experiment.chpl --llvm --savec=example/llvm-bcs/ ";
const char* chpl_compileVersion = "1.10.0.4079601";
...
void chpl_program_about() {
  printf("%s", "Compilation command: chpl -g -o ../example/experiment ../example/experiment.chpl --llvm --savec=example/llvm-bcs/ \n");
  printf("%s", "Chapel compiler version: 1.10.0.4079601\n");
