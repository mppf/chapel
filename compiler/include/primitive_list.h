...
// but rather in AST/primitive.cpp
  ...
  PRIMITIVE_R(PRIM_MAYBE_LOCAL_ARR_ELEM)
  PRIMITIVE_R(PRIM_MAYBE_AGGREGATE_ASSIGN)
  ...
  PRIMITIVE_R(PRIM_RESOLUTION_POINT)
  ...
  PRIMITIVE_R(PRIM_IS_EXTERN_UNION_TYPE)
  ...
  PRIMITIVE_R(PRIM_GET_VISIBLE_SYMBOLS)
