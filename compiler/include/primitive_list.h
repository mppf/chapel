...
// but rather in primitive.cpp
  ...
  PRIMITIVE_R(PRIM_NO_INIT)
  PRIMITIVE_R(PRIM_TYPE_INIT)
  ...
  PRIMITIVE_R(PRIM_IS_SUBTYPE_ALLOW_VALUES)
  ...
  PRIMITIVE_G(PRIM_CHPL_COMM_BUFF_GET)
  ...
  PRIMITIVE_G(PRIM_HEAP_REGISTER_GLOBAL_VAR)
  PRIMITIVE_G(PRIM_HEAP_BROADCAST_GLOBAL_VARS)
