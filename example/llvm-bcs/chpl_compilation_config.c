...
#include <stdio.h>
const char* chpl_compileCommand = "chpl -g -o experiment experiment.chpl --llvm --savec=llvm-bcs/ ";
...
void chpl_program_about() {
  printf("%s", "Compilation command: chpl -g -o experiment experiment.chpl --llvm --savec=llvm-bcs/ \n");
