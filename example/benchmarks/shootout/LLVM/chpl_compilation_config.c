...
#include <stdio.h>
const char* chpl_compileCommand = "chpl example/benchmarks/shootout/mandelbrot.chpl --llvm --savec=example/benchmarks/shootout/LLVM/ ";
...
void chpl_program_about() {
  printf("%s", "Compilation command: chpl example/benchmarks/shootout/mandelbrot.chpl --llvm --savec=example/benchmarks/shootout/LLVM/ \n");
