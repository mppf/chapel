...
#include <stdio.h>
const char* chpl_compileCommand = "chpl -g -o example/experiment example/experiment.chpl --llvm --savec=example/Testllvm/ ";
...
void chpl_program_about() {
  printf("%s", "Compilation command: chpl -g -o example/experiment example/experiment.chpl --llvm --savec=example/Testllvm/ \n");
