...
#include <stdio.h>
const char* chpl_compileCommand = "chpl hello4-datapar-dist.chpl --llvm --savec Testllvm/hello4/ ";
...
void chpl_program_about() {
  printf("%s", "Compilation command: chpl hello4-datapar-dist.chpl --llvm --savec Testllvm/hello4/ \n");
