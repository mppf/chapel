    ...
    if (opt < CURLOPTTYPE_OBJECTPOINT) {
      ...
      if chpl_isAnyCPtr(arg.type) {
        ...
        err = curl_easy_setopt_ptr(curl, opt:CURLoption,
                                   c_ptrToConst_helper(arg.localize()):c_string:c_ptr(void));
      }
    } else {
  ...
  */
  ...
  module CurlQioIntegration {
    ...
    proc openCurlFile(url:string,
      ...
      memcpy(url_c:c_void_ptr, c_ptrToConst_helper(url.localize()):c_string:c_ptr(void), url.size.safeCast(c_size_t));
