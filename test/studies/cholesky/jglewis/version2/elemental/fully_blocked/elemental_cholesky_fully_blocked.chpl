module elemental_cholesky_fully_blocked {
  ...
  proc elemental_cholesky_fully_blocked ( A : [] )
	...
	for ( A11_cols, A22_cols ) in
	  local_reduced_matrix_cyclic_partition_fb ( A_idx_range ) 
	  do {
		...
		// local {
		transposed_fully_blocked_triangular_solve (A11, I_compute_L21);
		// }
